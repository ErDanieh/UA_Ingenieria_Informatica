...
int main()
{
	...
	IndexadorHash b("./StopWordsIngles.txt", ". ,:", false, false, "./indicePruebaIngles", 1, false, false);
	b.IndexarDirectorio("CorpusTime/Documentos/");
	b.GuardarIndexacion();
	...
	double bb = getcputime() - aa;
	cout << "\nHa tardado " << bb << " segundos con DFR y stemming:\n\n";
	...
	// a.ImprimirResultadoBusqueda(423);
	double bbB = getcputime() - aaB;
	cout << "\nHa tardado " << bbB << " segundos con BM25 y stemming:\n\n";
