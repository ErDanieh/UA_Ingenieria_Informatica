...
% Vectores desde el SR DH al CDG del eslab�n
rdata = zeros (6,3);
rdata(1,:) = [0,0.1170,0];
...
G = 50 * ones(1,6);     % Coeficiente de reducci�n del
B = zeros(1,6);         % Fricci�n viscosa
Tc_plus = zeros(1,6);   % Fricci�n de Coulomb
Tc_minus = zeros(1,6);  % Fricci�n de Coulomb
